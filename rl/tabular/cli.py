...
from tabular.plot import plot_returns
...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_parser.add_argument("--algorithm", default="q-learning", choices=AGENT_NAMES)
    train_parser.add_argument("--show-policy", action="store_true")
...
def train_command(args: argparse.Namespace) -> None:
    ...
    if (
        args.show_policy
        and isinstance(env, GridWorldEnv)
        and hasattr(agent, "q_values")
    ):
        print()
