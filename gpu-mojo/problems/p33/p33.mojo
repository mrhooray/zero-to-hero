    ...
    with DeviceContext() as ctx:
        ...
        if mode == "--tensor-core":
            ...
            if tc_success and tiled_success:
                ...
                print("   - Tensor Core:", "PASS" if tc_success else "FAIL")
                print(
                    "   - Idiomatic Tiled:", "PASS" if tiled_success else "FAIL"
                )
