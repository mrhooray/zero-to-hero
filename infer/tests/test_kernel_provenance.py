...
RUNTIME_WRAPPER = ROOT / "src/infer/models/glm53_flash/ops/prefill_kda.py"
PROVENANCE_NOTICE = ROOT / "src/infer/models/glm53_flash/ops/prefill_kda.LICENSE.txt"
...
class FlashKDAProvenanceTest(unittest.TestCase):
    def test_profile_reports_the_installer_revision(self) -> None:
        ...
        self.assertEqual(glm53_flash.CUTLASS_COMMIT, install_flash_kda.CUTLASS_COMMIT)

    def test_runtime_wrapper_matches_the_installer(self) -> None:
        self.assertEqual(wrapper_version(), install_flash_kda.FLASH_KDA_VERSION)
