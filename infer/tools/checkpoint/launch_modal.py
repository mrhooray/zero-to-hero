...
def main(argv: list[str] | None = None) -> int:
    ...
    launcher = {
        ...
        "job_name": job_name,
        "modal_environment": args.environment,
...
def create_stage_sandbox(
    ...
    checkpoint_root = (
        f"{CHECKPOINT_MOUNT}/{volume_subpath}" if volume_subpath else CHECKPOINT_MOUNT
    )
